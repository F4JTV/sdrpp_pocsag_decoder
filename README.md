...
6. Keep **Low Pass** enabled unless you are debugging — it improves decoding
   in almost every situation.
7. If you see synchronization but the output is garbled, try the
   **Invert FSK** checkbox. Some networks transmit reversed FSK polarity.
8. Click **Show Messages** to open the decoded-messages window.
